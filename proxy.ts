...
export const config = {
  matcher: ["/((?!api/health|_next/static|_next/image|favicon.ico|manifest.webmanifest|sw.js|offline.html|icon-192x192.png|icon-512x512.png|apple-touch-icon.png|icon-maskable-512x512.png).*)"],
};
