...
export function minerFundamentalsFromRow(row: Record<string, unknown>): MinerFundamentals {
  return {
    ...
    economicStudyStage: row.economic_study_stage == null ? null : String(row.economic_study_stage) as MinerFundamentals["economicStudyStage"],
    economicStudyDate: row.economic_study_date == null ? null : String(row.economic_study_date),
    nextStudyStage: row.next_study_stage == null ? null : String(row.next_study_stage) as MinerFundamentals["nextStudyStage"],
