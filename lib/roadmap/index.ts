...
export const roadmapPhases: RoadmapPhase[] = [
  {
    ...
    items: [
      ...
      { title: "Passkeys", status: "in_progress", detail: "Passkey registration is moving behind authenticated Security settings; password login remains the recovery path." },
