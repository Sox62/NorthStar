...
export const roadmapPhases: RoadmapPhase[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { title: "ASX/NYSE/TSX end-of-day prices", status: "in_progress", detail: "Manual, CSV, scheduled and provider-selected delayed quote refreshes persist to the price ledger with full-provider historical backfill, EODHD, Global X NAV, Yahoo and Stooq fallback plus visible quote/failure audit details." },
  ...
  },
  {
    ...
    items: [
      ...
      { title: "Research benchmark universe", status: "shipped", detail: "Relative leadership can compare holdings or non-owned research candidates against permanent benchmarks including gold, SPY, RSP, QQQ, USD and sector proxies." },
