...
export const roadmapPhases: RoadmapPhase[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { title: "ASX/NYSE/TSX end-of-day prices", status: "in_progress", detail: "Manual, CSV, scheduled and provider-selected delayed quote refreshes persist to the price ledger with EODHD, Global X NAV, Yahoo and Stooq fallback plus visible quote/failure audit details." },
