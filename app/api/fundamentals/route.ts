...
const fundamentalsSchema = z.object({
  ...
  quantityUnit: z.preprocess((value) => value === "" || value === undefined ? null : value, z.enum(["oz", "lb", "t"]).nullable()),
  productionPeriod: z.preprocess((value) => value === "" || value === undefined ? null : value, z.enum(["quarter", "half", "year"]).nullable()),
  costBasis: z.preprocess((value) => value === "" || value === undefined ? null : value, z.enum(["aisc_byproduct", "aisc_ageq", "cash_cost", "cas"]).nullable()),
  economicStudyStage: z.preprocess((value) => value === "" || value === undefined ? null : value, z.enum(["scoping", "pfs", "dfs"]).nullable()),
  economicStudyDate: nullableDate,
  nextStudyStage: z.preprocess((value) => value === "" || value === undefined ? null : value, z.enum(["scoping", "pfs", "dfs"]).nullable()),
  balanceAsOfDate: nullableDate,
  marketCapAsOfDate: nullableDate,
  lastCapitalEventDate: nullableDate,
  lastEquityEventDate: nullableDate,
  lastDebtEventDate: nullableDate,
