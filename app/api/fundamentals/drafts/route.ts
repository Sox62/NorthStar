...
export async function POST(request: Request) {
  try {
    ...
    return NextResponse.json({ draft: await getStorage().createFundamentalResearchDraft({ ...input, quantityUnit: null, productionPeriod: null, costBasis: null, economicStudyStage: null, economicStudyDate: null, nextStudyStage: null, balanceAsOfDate: null, marketCapAsOfDate: null, lastCapitalEventDate: null, lastEquityEventDate: null, lastDebtEventDate: null }) }, { status: 201 });
  } catch (error) {
