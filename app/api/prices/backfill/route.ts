...
const BENCHMARK_BACKFILL_INSTRUMENTS: Record<string, PriceableInstrument> = {
  ...
  DBC: benchmarkInstrument("DBC", "AMEX", "Invesco DB Commodity Index Tracking Fund", "USD", "Broad commodities"),
  XME: benchmarkInstrument("XME", "AMEX", "SPDR S&P Metals & Mining ETF", "USD", "Commodity equities"),
  IWM: benchmarkInstrument("IWM", "AMEX", "iShares Russell 2000 ETF", "USD", "Equity breadth"),
  CPIAUCSL: benchmarkInstrument("CPIAUCSL", "FRED", "US CPI index", "USD", "Macro inflation"),
